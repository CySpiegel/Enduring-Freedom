...
_markerArray = ["aosite","aosite_1","aosite_2","aosite_3","aosite_4","aosite_5","aosite_6","aosite_7","aosite_8","aosite_9","aosite_10","aosite_11","aosite_12"];
...
fn_spawnArtyMission = {
	...
	_arty1 = createVehicle ["O_MBT_02_arty_F", _newPos1, [], 0, "NONE"];
	_arty1 setFuel 0;
	_arty1 setDamage 0;
	sleep 0.3;	
	_arty2 = createVehicle ["O_MBT_02_arty_F", _newPos2, [], 0, "NONE"];
	_arty2 setFuel 0;
	_arty2 setDamage 0;
	sleep 0.3;	
	...
	_crew1 = [ _arty1 , _armor, false, "", "O_crew_F" ] call BIS_fnc_spawnCrew;
	sleep 0.3;
	_crew2 = [ _arty2 , _armor, false, "", "O_crew_F" ] call BIS_fnc_spawnCrew;
	sleep 0.3;
	
	//Spawning in foot patrol units
	_grp1A = [getMarkerPos _markerAO, EAST, (configfile >> "CfgGroups" >> "East" >> "OPF_F" >> "Infantry" >> "OIA_InfTeam")] call BIS_fnc_spawnGroup;
	_defendHq = [_grp1A, _markerAO, 300] call BIS_fnc_taskDefend;
	sleep 0.3;	

	//Creating Vehicle Patrol
	_vehiclePatrol = createGroup EAST;
	_vehicle1 = [_newPos3, 10, "O_MRAP_02_hmg_F", _vehiclePatrol] call BIS_fnc_spawnvehicle;
	sleep 0.3;	
	_vehicle2 = [_newPos4, 10, "O_MRAP_02_hmg_F", _vehiclePatrol] call BIS_fnc_spawnvehicle;
	sleep 0.3;
	...
	_null = [west, "mob_arty", ["Must destroy two opfor Sochor", "Destroy Artillery", "Destroy Artillery"], getMarkerPos "mob_arty", false] spawn BIS_fnc_taskCreate;
...
fn_spawnCasMission = {
	...
	_mhq = [_newPosHQ, "Military", "fuel", "OPF_F", "Small", 0] call ALIVE_fnc_spawnRandomPopulatedComposition;
	...
	[_newPos1, 10, "O_MBT_04_command_F", _tanques1] call BIS_fnc_spawnvehicle;
	sleep 3;
	[_newPos2, 10, "O_MBT_04_cannon_F", _tanques1] call BIS_fnc_spawnvehicle;
	sleep 3;
	[_newPos3, 10, "O_MBT_04_cannon_F", _tanques1] call BIS_fnc_spawnvehicle;
	sleep 3;
	[_newPos4, 10, "O_MBT_04_cannon_F", _tanques1] call BIS_fnc_spawnvehicle;
	sleep 3;
...
fn_spawnConvoyMission = {
	...
	_convoy1 = createGroup EAST;
	[_newPos, 10, "I_C_Offroad_02_LMG_F", _convoy1] call BIS_fnc_spawnvehicle;
	nul = [_convoy1,getPos _shed2, 300] call BIS_fnc_taskPatrol;
	sleep 15;
	[_newPos, 10, "I_C_Offroad_02_AT_F", _convoy1] call BIS_fnc_spawnvehicle;
	sleep 15;
	[_newPos, 10, "I_C_Van_02_vehicle_F", _convoy1] call BIS_fnc_spawnvehicle;
	sleep 15;
	[_newPos, 10, "I_C_Van_02_vehicle_F", _convoy1] call BIS_fnc_spawnvehicle;
	sleep 15;
	[_newPos, 10, "I_C_Van_02_vehicle_F", _convoy1] call BIS_fnc_spawnvehicle;
...
fn_spawnPlacementMission = {
	...
	_grp1A = [getMarkerPos _markerAO, independent, ["I_C_Soldier_Bandit_4_F"]] call BIS_fnc_spawnGroup;
	nul = [_grp1A,getpos _warehouse] call BIS_fnc_taskDefend;
	
	_AA2 = createGroup EAST;
