...
force force acre_sys_core_ts3ChannelName = "Operations Room 1";
...
// ADV - ACE CPR
force force adv_aceCPR_addTime = 35.1622;
force force adv_aceCPR_AED_stationType = """Land_Defibrillator_F""";
force force adv_aceCPR_chance_0 = 29.8786;
force force adv_aceCPR_chance_1 = 45.0513;
force force adv_aceCPR_chance_2 = 59.6404;
